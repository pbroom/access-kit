...
| IR | Emergency revocation, connector outage, compromised credential, decision API outage, break-glass approval, incident notification, and post-action review runbooks. | `runbooks/*.md`, `tests/core/admin-authorization.test.ts` | Exercised incident records and retained post-action reviews. |
