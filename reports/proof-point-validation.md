...
Generated at: 2026-05-28T13:14:27.484Z

Branch: codex/thermo-evidence-package-builder
...
```text
> access-kit@0.1.0 typecheck /Users/peterbroomfield/access-kit-thermo-evidence-builder
> tsc --noEmit
```
...
```text
> access-kit@0.1.0 validate:schemas /Users/peterbroomfield/access-kit-thermo-evidence-builder
...
```text
> access-kit@0.1.0 validate:openapi /Users/peterbroomfield/access-kit-thermo-evidence-builder
> tsx scripts/validate-openapi.ts

Validated OpenAPI contract at /Users/peterbroomfield/access-kit-thermo-evidence-builder/openapi/rebac-control-plane.yaml.
...
```text
> access-kit@0.1.0 validate:api-collections /Users/peterbroomfield/access-kit-thermo-evidence-builder
...
```text
> access-kit@0.1.0 validate:policy /Users/peterbroomfield/access-kit-thermo-evidence-builder
...
```text
> access-kit@0.1.0 validate:connector-security /Users/peterbroomfield/access-kit-thermo-evidence-builder
...
```text
> access-kit@0.1.0 validate:cli-contract /Users/peterbroomfield/access-kit-thermo-evidence-builder
> vitest run tests/cli/cli-contract.test.ts


 RUN  v4.1.7 /Users/peterbroomfield/access-kit-thermo-evidence-builder


 Test Files  1 passed (1)
      Tests  6 passed (6)
   Start at  09:14:20
   Duration  327ms (transform 163ms, setup 0ms, import 250ms, tests 22ms, environment 0ms)
```

### container packaging validation

```text
> access-kit@0.1.0 validate:packaging /Users/peterbroomfield/access-kit-thermo-evidence-builder
...
```text
> access-kit@0.1.0 validate:release-packaging /Users/peterbroomfield/access-kit-thermo-evidence-builder
...
```text
> access-kit@0.1.0 validate:deployment-manifests /Users/peterbroomfield/access-kit-thermo-evidence-builder
...
```text
> access-kit@0.1.0 validate:persistence-deployment /Users/peterbroomfield/access-kit-thermo-evidence-builder
...
```text
> access-kit@0.1.0 validate:runbook-exercises /Users/peterbroomfield/access-kit-thermo-evidence-builder
...
```text
> access-kit@0.1.0 validate:secure-sdlc /Users/peterbroomfield/access-kit-thermo-evidence-builder
...
```text
> access-kit@0.1.0 validate:live-enforcement-pilot /Users/peterbroomfield/access-kit-thermo-evidence-builder
...
```text
> access-kit@0.1.0 test:core /Users/peterbroomfield/access-kit-thermo-evidence-builder
> vitest run tests/core
 ...
 Test Files  14 passed (14)
   ...
   Start at  09:14:23
   Duration  275ms (transform 1.39s, setup 0ms, import 1.95s, tests 133ms, environment 1ms)
```

### API runtime tests

```text
> access-kit@0.1.0 test:api /Users/peterbroomfield/access-kit-thermo-evidence-builder
> vitest run tests/api
 ...
 Test Files  7 passed (7)
   ...
   Start at  09:14:24
   Duration  567ms (transform 1.03s, setup 0ms, import 1.70s, tests 450ms, environment 0ms)
```

### SDK PEP conformance tests

```text
> access-kit@0.1.0 test:sdk-pep /Users/peterbroomfield/access-kit-thermo-evidence-builder
> vitest run tests/sdk-pep
 ...
 Test Files  4 passed (4)
      Tests  24 passed (24)
   Start at  09:14:24
   Duration  484ms (transform 369ms, setup 0ms, import 564ms, tests 219ms, environment 0ms)
```

### sample internal admin app tests

```text
> access-kit@0.1.0 validate:sample-admin-app /Users/peterbroomfield/access-kit-thermo-evidence-builder
> vitest run tests/examples/internal-admin-app.test.ts
 ...
 Test Files  1 passed (1)
      Tests  8 passed (8)
   Start at  09:14:25
   Duration  175ms (transform 93ms, setup 0ms, import 115ms, tests 6ms, environment 0ms)
```
...
RUN  v4.1.7 /Users/peterbroomfield/access-kit-thermo-evidence-builder
 ...
 Test Files  8 passed (8)
      Tests  47 passed (47)
   Start at  09:14:26
   Duration  284ms (transform 1.05s, setup 0ms, import 1.42s, tests 71ms, environment 0ms)
```

### CLI API smoke tests

```text
> access-kit@0.1.0 test:cli /Users/peterbroomfield/access-kit-thermo-evidence-builder
> vitest run tests/cli
 ...
 Test Files  3 passed (3)
      Tests  50 passed (50)
   Start at  09:14:26
   Duration  371ms (transform 472ms, setup 0ms, import 746ms, tests 122ms, environment 0ms)
```
