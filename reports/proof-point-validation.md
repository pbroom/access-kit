...
```text
> access-kit@0.1.0 typecheck /Users/peterbroomfield/access-kit-greptile-5
> tsc --noEmit
```
...
```text
> access-kit@0.1.0 validate:schemas /Users/peterbroomfield/access-kit-greptile-5
...
```text
> access-kit@0.1.0 validate:openapi /Users/peterbroomfield/access-kit-greptile-5
> tsx scripts/validate-openapi.ts

Validated OpenAPI contract at /Users/peterbroomfield/access-kit-greptile-5/openapi/rebac-control-plane.yaml.
...
```text
> access-kit@0.1.0 validate:policy /Users/peterbroomfield/access-kit-greptile-5
...
```text
> access-kit@0.1.0 validate:connector-security /Users/peterbroomfield/access-kit-greptile-5
...
```text
> access-kit@0.1.0 validate:cli-contract /Users/peterbroomfield/access-kit-greptile-5
> vitest run tests/cli/cli-contract.test.ts


 RUN  v4.1.7 /Users/peterbroomfield/access-kit-greptile-5
...
```text
> access-kit@0.1.0 validate:packaging /Users/peterbroomfield/access-kit-greptile-5
...
```text
> access-kit@0.1.0 validate:release-packaging /Users/peterbroomfield/access-kit-greptile-5
...
```text
> access-kit@0.1.0 validate:deployment-manifests /Users/peterbroomfield/access-kit-greptile-5
...
```text
> access-kit@0.1.0 validate:persistence-deployment /Users/peterbroomfield/access-kit-greptile-5
...
```text
> access-kit@0.1.0 test:core /Users/peterbroomfield/access-kit-greptile-5
...
```text
> access-kit@0.1.0 test:api /Users/peterbroomfield/access-kit-greptile-5
...
```text
> access-kit@0.1.0 test:cli /Users/peterbroomfield/access-kit-greptile-5
