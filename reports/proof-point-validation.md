...
Generated at: 2026-05-23T17:10:10.489Z

Branch: codex/rebac-api-container
...
```text
> access-kit@0.1.0 typecheck /Users/peterbroomfield/access-kit-rebac-api-container
> tsc --noEmit
```
...
```text
> access-kit@0.1.0 validate:schemas /Users/peterbroomfield/access-kit-rebac-api-container
...
```text
> access-kit@0.1.0 validate:openapi /Users/peterbroomfield/access-kit-rebac-api-container
> tsx scripts/validate-openapi.ts

Validated OpenAPI contract at /Users/peterbroomfield/access-kit-rebac-api-container/openapi/rebac-control-plane.yaml.
...
```text
> access-kit@0.1.0 validate:policy /Users/peterbroomfield/access-kit-rebac-api-container
...
```text
> access-kit@0.1.0 validate:cli-contract /Users/peterbroomfield/access-kit-rebac-api-container
> vitest run tests/cli/cli-contract.test.ts


 RUN  v4.1.7 /Users/peterbroomfield/access-kit-rebac-api-container


 Test Files  1 passed (1)
      Tests  3 passed (3)
   Start at  13:10:06
   Duration  170ms (transform 37ms, setup 0ms, import 56ms, tests 7ms, environment 0ms)
```

### container packaging validation

```text
> access-kit@0.1.0 validate:packaging /Users/peterbroomfield/access-kit-rebac-api-container
...
```text
> access-kit@0.1.0 test:core /Users/peterbroomfield/access-kit-rebac-api-container
> vitest run tests/core
 ...
 Test Files  2 passed (2)
      Tests  25 passed (25)
   Start at  13:10:07
   Duration  189ms (transform 108ms, setup 0ms, import 143ms, tests 14ms, environment 0ms)
```

### API runtime tests

```text
> access-kit@0.1.0 test:api /Users/peterbroomfield/access-kit-rebac-api-container
> vitest run tests/api
 ...
 Test Files  1 passed (1)
      Tests  65 passed (65)
   Start at  13:10:08
   Duration  477ms (transform 115ms, setup 0ms, import 154ms, tests 225ms, environment 0ms)
```

### CLI API smoke tests

```text
> access-kit@0.1.0 test:cli /Users/peterbroomfield/access-kit-rebac-api-container
> vitest run tests/cli
 ...
 Test Files  2 passed (2)
      Tests  29 passed (29)
   Start at  13:10:09
   Duration  320ms (transform 158ms, setup 0ms, import 214ms, tests 78ms, environment 0ms)
```
...
- Harden API service packaging with image signing/provenance, registry publishing, IaC probe wiring, deployment runbooks, identity-provider-backed authentication, and operator authorization.
