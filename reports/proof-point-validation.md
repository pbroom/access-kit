...
Generated at: 2026-05-28T13:25:00.824Z

Branch: codex/thermo-api-collection-renderer
...
```text
> access-kit@0.1.0 typecheck /Users/peterbroomfield/access-kit-thermo-api-collections
> tsc --noEmit
```
...
```text
> access-kit@0.1.0 validate:schemas /Users/peterbroomfield/access-kit-thermo-api-collections
...
```text
> access-kit@0.1.0 validate:openapi /Users/peterbroomfield/access-kit-thermo-api-collections
> tsx scripts/validate-openapi.ts

Validated OpenAPI contract at /Users/peterbroomfield/access-kit-thermo-api-collections/openapi/rebac-control-plane.yaml.
...
```text
> access-kit@0.1.0 validate:api-collections /Users/peterbroomfield/access-kit-thermo-api-collections
...
```text
> access-kit@0.1.0 validate:policy /Users/peterbroomfield/access-kit-thermo-api-collections
...
```text
> access-kit@0.1.0 validate:connector-security /Users/peterbroomfield/access-kit-thermo-api-collections
...
```text
> access-kit@0.1.0 validate:cli-contract /Users/peterbroomfield/access-kit-thermo-api-collections
> vitest run tests/cli/cli-contract.test.ts


 RUN  v4.1.7 /Users/peterbroomfield/access-kit-thermo-api-collections


 Test Files  1 passed (1)
      Tests  6 passed (6)
   Start at  09:24:52
   Duration  385ms (transform 192ms, setup 0ms, import 296ms, tests 24ms, environment 0ms)
```

### container packaging validation

```text
> access-kit@0.1.0 validate:packaging /Users/peterbroomfield/access-kit-thermo-api-collections
...
```text
> access-kit@0.1.0 validate:release-packaging /Users/peterbroomfield/access-kit-thermo-api-collections
...
```text
> access-kit@0.1.0 validate:deployment-manifests /Users/peterbroomfield/access-kit-thermo-api-collections
...
```text
> access-kit@0.1.0 validate:persistence-deployment /Users/peterbroomfield/access-kit-thermo-api-collections
...
```text
> access-kit@0.1.0 validate:runbook-exercises /Users/peterbroomfield/access-kit-thermo-api-collections
...
```text
> access-kit@0.1.0 validate:secure-sdlc /Users/peterbroomfield/access-kit-thermo-api-collections
...
```text
> access-kit@0.1.0 validate:live-enforcement-pilot /Users/peterbroomfield/access-kit-thermo-api-collections
...
```text
> access-kit@0.1.0 test:core /Users/peterbroomfield/access-kit-thermo-api-collections
> vitest run tests/core
 ...
 Test Files  14 passed (14)
   ...
   Start at  09:24:56
   Duration  322ms (transform 1.64s, setup 0ms, import 2.33s, tests 152ms, environment 1ms)
```

### API runtime tests

```text
> access-kit@0.1.0 test:api /Users/peterbroomfield/access-kit-thermo-api-collections
> vitest run tests/api
 ...
 Test Files  7 passed (7)
   ...
   Start at  09:24:56
   Duration  733ms (transform 1.36s, setup 0ms, import 2.24s, tests 565ms, environment 0ms)
```

### SDK PEP conformance tests

```text
> access-kit@0.1.0 test:sdk-pep /Users/peterbroomfield/access-kit-thermo-api-collections
> vitest run tests/sdk-pep
 ...
 Test Files  4 passed (4)
      Tests  24 passed (24)
   Start at  09:24:57
   Duration  620ms (transform 508ms, setup 0ms, import 758ms, tests 253ms, environment 0ms)
```

### sample internal admin app tests

```text
> access-kit@0.1.0 validate:sample-admin-app /Users/peterbroomfield/access-kit-thermo-api-collections
> vitest run tests/examples/internal-admin-app.test.ts
 ...
 Test Files  1 passed (1)
      Tests  8 passed (8)
   Start at  09:24:58
   Duration  206ms (transform 106ms, setup 0ms, import 133ms, tests 7ms, environment 0ms)
```
...
RUN  v4.1.7 /Users/peterbroomfield/access-kit-thermo-api-collections
 ...
 Test Files  8 passed (8)
      Tests  47 passed (47)
   Start at  09:24:59
   Duration  319ms (transform 1.17s, setup 0ms, import 1.62s, tests 76ms, environment 0ms)
```

### CLI API smoke tests

```text
> access-kit@0.1.0 test:cli /Users/peterbroomfield/access-kit-thermo-api-collections
> vitest run tests/cli
 ...
 Test Files  3 passed (3)
      Tests  50 passed (50)
   Start at  09:25:00
   Duration  468ms (transform 578ms, setup 0ms, import 951ms, tests 162ms, environment 0ms)
```
