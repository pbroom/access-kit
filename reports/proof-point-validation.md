...
Generated at: 2026-05-26T10:23:58.805Z

Branch: codex/greptile-production-store-audit-hardening
...
```text
> access-kit@0.1.0 typecheck /Users/peterbroomfield/access-kit-greptile-4
> tsc --noEmit
```
...
```text
> access-kit@0.1.0 validate:schemas /Users/peterbroomfield/access-kit-greptile-4
...
```text
> access-kit@0.1.0 validate:openapi /Users/peterbroomfield/access-kit-greptile-4
> tsx scripts/validate-openapi.ts

Validated OpenAPI contract at /Users/peterbroomfield/access-kit-greptile-4/openapi/rebac-control-plane.yaml.
...
```text
> access-kit@0.1.0 validate:policy /Users/peterbroomfield/access-kit-greptile-4
...
```text
> access-kit@0.1.0 validate:connector-security /Users/peterbroomfield/access-kit-greptile-4
...
```text
> access-kit@0.1.0 validate:cli-contract /Users/peterbroomfield/access-kit-greptile-4
> vitest run tests/cli/cli-contract.test.ts


 RUN  v4.1.7 /Users/peterbroomfield/access-kit-greptile-4


 Test Files  1 passed (1)
      Tests  5 passed (5)
   Start at  06:23:51
   Duration  424ms (transform 176ms, setup 0ms, import 294ms, tests 32ms, environment 0ms)
```

### container packaging validation

```text
> access-kit@0.1.0 validate:packaging /Users/peterbroomfield/access-kit-greptile-4
...
```text
> access-kit@0.1.0 validate:release-packaging /Users/peterbroomfield/access-kit-greptile-4
...
```text
> access-kit@0.1.0 validate:deployment-manifests /Users/peterbroomfield/access-kit-greptile-4
...
```text
> access-kit@0.1.0 validate:persistence-deployment /Users/peterbroomfield/access-kit-greptile-4
...
```text
> access-kit@0.1.0 test:core /Users/peterbroomfield/access-kit-greptile-4
> vitest run tests/core
 ...
 Test Files  8 passed (8)
   ...
   Start at  06:23:55
   Duration  359ms (transform 1.03s, setup 0ms, import 1.32s, tests 105ms, environment 0ms)
```

### API runtime tests

```text
> access-kit@0.1.0 test:api /Users/peterbroomfield/access-kit-greptile-4
> vitest run tests/api
 ...
 Test Files  4 passed (4)
      Tests  97 passed (97)
   Start at  06:23:55
   Duration  704ms (transform 687ms, setup 0ms, import 1.02s, tests 333ms, environment 0ms)
```
...
RUN  v4.1.7 /Users/peterbroomfield/access-kit-greptile-4
 ...
 Test Files  1 passed (1)
      Tests  7 passed (7)
   Start at  06:23:57
   Duration  279ms (transform 135ms, setup 0ms, import 166ms, tests 23ms, environment 0ms)
```

### CLI API smoke tests

```text
> access-kit@0.1.0 test:cli /Users/peterbroomfield/access-kit-greptile-4
> vitest run tests/cli
 ...
 Test Files  3 passed (3)
      Tests  33 passed (33)
   Start at  06:23:57
   Duration  465ms (transform 465ms, setup 0ms, import 843ms, tests 158ms, environment 0ms)
```
