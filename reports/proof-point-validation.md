...
Generated at: 2026-05-26T19:00:21.946Z

Branch: codex/rebac-sample-policy-repo
...
```text
> access-kit@0.1.0 typecheck /Users/peterbroomfield/access-kit-sample-policy-repo
> tsc --noEmit
```
...
```text
> access-kit@0.1.0 validate:schemas /Users/peterbroomfield/access-kit-sample-policy-repo
...
```text
> access-kit@0.1.0 validate:openapi /Users/peterbroomfield/access-kit-sample-policy-repo
> tsx scripts/validate-openapi.ts

Validated OpenAPI contract at /Users/peterbroomfield/access-kit-sample-policy-repo/openapi/rebac-control-plane.yaml.
...
```text
> access-kit@0.1.0 validate:policy /Users/peterbroomfield/access-kit-sample-policy-repo
...
```text
> access-kit@0.1.0 validate:connector-security /Users/peterbroomfield/access-kit-sample-policy-repo
...
```text
> access-kit@0.1.0 validate:cli-contract /Users/peterbroomfield/access-kit-sample-policy-repo
> vitest run tests/cli/cli-contract.test.ts


 RUN  v4.1.7 /Users/peterbroomfield/access-kit-sample-policy-repo


 Test Files  1 passed (1)
      Tests  5 passed (5)
   Start at  15:00:13
   Duration  567ms (transform 262ms, setup 0ms, import 422ms, tests 35ms, environment 0ms)
```

### container packaging validation

```text
> access-kit@0.1.0 validate:packaging /Users/peterbroomfield/access-kit-sample-policy-repo
...
```text
> access-kit@0.1.0 validate:release-packaging /Users/peterbroomfield/access-kit-sample-policy-repo
...
```text
> access-kit@0.1.0 validate:deployment-manifests /Users/peterbroomfield/access-kit-sample-policy-repo
...
```text
> access-kit@0.1.0 validate:persistence-deployment /Users/peterbroomfield/access-kit-sample-policy-repo
...
```text
> access-kit@0.1.0 test:core /Users/peterbroomfield/access-kit-sample-policy-repo
> vitest run tests/core
 ...
 Test Files  8 passed (8)
   ...
   Start at  15:00:17
   Duration  438ms (transform 1.21s, setup 0ms, import 1.55s, tests 132ms, environment 1ms)
```

### API runtime tests

```text
> access-kit@0.1.0 test:api /Users/peterbroomfield/access-kit-sample-policy-repo
> vitest run tests/api
 ...
 Test Files  4 passed (4)
      Tests  97 passed (97)
   Start at  15:00:18
   Duration  929ms (transform 832ms, setup 0ms, import 1.25s, tests 470ms, environment 0ms)
```
...
RUN  v4.1.7 /Users/peterbroomfield/access-kit-sample-policy-repo
 ...
 Test Files  1 passed (1)
      Tests  11 passed (11)
   Start at  15:00:19
   Duration  347ms (transform 168ms, setup 0ms, import 208ms, tests 26ms, environment 0ms)
```

### CLI API smoke tests

```text
> access-kit@0.1.0 test:cli /Users/peterbroomfield/access-kit-sample-policy-repo
> vitest run tests/cli
 ...
 Test Files  3 passed (3)
      Tests  33 passed (33)
   Start at  15:00:20
   Duration  586ms (transform 589ms, setup 0ms, import 1.07s, tests 208ms, environment 0ms)
```
