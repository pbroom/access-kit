...
export const automationContract = {
  ...
  validationPlans: [
    {
      ...
      requiredScripts: [
        ...
        "validate:runbook-exercises",
        "validate:secure-sdlc",
        "validate:live-enforcement-pilot",
        "validate:pep-conformance",
        "validate:sample-saas-app",
  ...
  packageScripts: [
    ...
    { name: "validate:docs-lint", command: "tsx scripts/validate-docs-lint.ts" },
    ...
    {
      name: "validate:live-enforcement-pilot",
      command: "tsx scripts/validate-live-enforcement-pilot.ts"
    }
  ],
  ...
  evidence: {
    commands: [
      ...
      { name: "API collection validation", args: ["validate:api-collections"] },
      { name: "documentation and packaging lint", args: ["validate:docs-lint"] },
      ...
      { name: "live enforcement pilot validation", args: ["validate:live-enforcement-pilot"] },
