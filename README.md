...
- Persistent storage repository contracts, local graph/audit/job adapters, and schema-backed production persistence manifest evidence checks for graph, audit, and job backends.
