...
- File-backed runtime state snapshots, public health/readiness probes, a `rebac-api` service entrypoint, and container packaging proof points.
...
- `docs/` - architecture, domain, API, CLI, deployment, security, ATO evidence, and outstanding requirements.
